...
ZIP निकालें, कोड पढ़ें, Safari बंद करें और `install.command` खोलें। पहले जाँच होगी; बदलाव के लिए `APPLY` लिखें। `sudo` नहीं चाहिए; Apple Swift आवश्यक है। macOS रोके तो सुरक्षा बंद न करें; मैनुअल विधि या सहायता लें।
